...
4. Click on "**Next**". Now you will receive an email from Google with a code ![Verification email](/assets/images/posts/2023-02-21-create-google-account-with-existing-email-address/verification-email.png)
